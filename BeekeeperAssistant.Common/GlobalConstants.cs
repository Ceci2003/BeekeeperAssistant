namespace BeekeeperAssistant.Common
{
    public static class GlobalConstants
    {
        ...
        public const string CityCodeRequiredErrorMessage = "";
        public const string FarmNumberRequiredErrorMessage = "";
        public const string ApiaryExistsErrorMessage = "";
        public const string ApiaryTypeRequiredErrorMessage = "";
    }
}
