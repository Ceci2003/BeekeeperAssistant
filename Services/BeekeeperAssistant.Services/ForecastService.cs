namespace BeekeeperAssistant.Services
{
    ...
    {
        public ForecastResult GetCurrentWeather(string cityName, string apiId)
        {
            // API path with CITY parameter and other parameters.
            string url = string.Format("http://api.openweathermap.org/data/2.5/weather?q={0}&units=metric&cnt=1&APPID={1}", cityName, apiId);
